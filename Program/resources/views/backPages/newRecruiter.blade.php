...
@section('backContent')
    ...
    <div class="content-wrapper">
                ...
                <div class="row mb-2">
                    ...
                    <div class="col-sm-6">
                        <ol class="breadcrumb float-sm-right">
                            <li class="breadcrumb-item"><a href="{{ route('Read_RecruiterList') }}">Recruiter list</a></li>
        ...
        <section class="content">
            <!-- container-fluid -->
            <div class="container-fluid">
                <form action="{{ route('Create_Recruiter') }}" method="POST" enctype="multipart/form-data">
                    @csrf
                    <div class="card">
