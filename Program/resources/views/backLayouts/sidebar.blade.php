        ...
        <aside class="main-sidebar sidebar-dark-primary elevation-4">
            ...
            <div class="sidebar">
                ...
                <div class="user-panel mt-3 pb-3 mb-3 d-flex">
                    <div class="image">
                        <img src="{{ asset('img') }}/pedebro.png" class="img-circle elevation-2"
                            alt="User Image">
                    </div>
                    <div class="info">
                        <a href="/profile" class="d-block">Admin Pedebro</a>
                    </div>
                </div>
                <!-- Sidebar Menu -->
                <nav class="mt-2">
                    <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu"
                        ...
                        <li
                            ...
                            <ul class="nav nav-treeview">
                                <li class="nav-item">
                                    <a href="{{ route('Read_JobVacancies') }}"
                        ...
                        <li
                            ...
                            <ul class="nav nav-treeview">
                                <li class="nav-item">
                                    <a href="{{ route('Read_RecruiterList') }}"
                                ...
                                <li class="nav-item">
                                    <a href="{{ route('Read_ApplicantList') }}"
                                        class="nav-link {{ $title === 'aList' ? 'active' : '' }}">
                                        <i class="far fa-circle nav-icon"></i>
                                        <p>Applicant list</p>
                                    </a>
                                </li>
